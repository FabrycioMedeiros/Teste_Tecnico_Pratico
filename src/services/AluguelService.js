...
class AluguelService {
  static async criarRegistroDeUtilizacao(aluguelData) {
    ...
    } catch (erro) { throw new Error(`Falha ao criar registro de utilização: ${erro.message}`); }
  }
  ...
  static async listarRegistrosDeUtilizacao() {
    ...
    } catch (erro) { throw new Error(`Falha ao listar registros de utilização: ${erro.message}`); }
  }
